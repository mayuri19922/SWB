...
function work_order_prod($start_date, $end_date, $available_wo = NULL , $work_center = NULL){
	...
	// print_r($select_work_orders); die;
...
function get_ref_data_query($reference_id = NULL){
	...
	$query = "SELECT \"OPTM_REF_ID\" AS \"ref_id\", CAST(\"OPTM_FROM_DATE\" as date) AS \"from_date\", CAST(\"OPTM_TO_DATE\" as date) AS \"to_date\", \"OPTM_SCHEDULING_STATUS\" AS \"scheduling_status\", \"OPTM_IS_DELETED\" AS \"is_deleted\", \"OPTM_PLAN_NAME\" AS \"plan_name\", \"WORKING_WC\" as \"working_wc\" FROM \"OPTM_APS_SCH_REF\"
	$where ";
	return $query;
}
